...
@app.route(
    "/api/financial_summary", methods=["GET"]
)  # @ is called an annotation, it tells Flask that this function should be called when a GET request is made to /api/financial_summary
